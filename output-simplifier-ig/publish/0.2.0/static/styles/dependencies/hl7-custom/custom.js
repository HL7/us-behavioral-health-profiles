...
// FIX ISSUES WITH THE HL7 BASE TEMPLATE COLLIDING WITH SIMPLIFIER STYLE

$(".header .navbar").removeClass("navbar-default").addClass("navbar-inverse");
$(".navbar-toggle .sr-only").text("");
