...
<tbody>
  ...
  <tr>
     ...
     <td class="tg-zzem">{{pagelink:structuredefinition-bh-grant-info, text: US Behavioral Health Grant Information Observation Profile}}</td>
     <td class="tg-0lax">observation.code</td>
  </tr>
  <tr>
     <td class="tg-0lax">Federal/State Grants Reporting Requirements</td>
