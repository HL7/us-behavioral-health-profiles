...
<ul>
  ...
  <li><a href="#scope-and-usage">Scope and Usage</a></li>
  <li><a href="#overview-of-implementation-guide">Overview of Implementation Guide</a></li>
  <li><a href="#audience">Audience</a></li>
  <li><a href="#how-to-read-this-implementation-guide">How to Read This Implementation Guide</a></li>
  ...
  <li><a href="#dependencies-on-other-igs">Dependencies on Other IGs</a></li>
  <li><a href="#authors-and-project-team">Authors and Project Team</a></li>
...
## Overview of Implementation Guide {#overview-of-implementation-guide}
...
It is recommended to review sections [How to Read This Implementation Guide](#how-to-read-this-implementation-guide) and [Limitations and Challenges](#limitations-and-challenges) below before exploring.
...
## How to Read This Implementation Guide {#how-to-read-this-implementation-guide}
...
<tbody>
  <tr>
    ...
    <td class="tg-uozz">{{pagelink:summary_story, text:Summary}}</td>
  ...
  <tr>
    <td class="tg-yd0e">User Story</td>
    <td class="tg-uozz">{{pagelink:quick_facts, text:Quick Facts}}</td>
  ...
  <tr>
    <td class="tg-yd0e">User Story</td>
    <td class="tg-uozz">{{pagelink:full_story, text:Full Care Story}}</td>
  ...
  <tr>
    ...
    <td class="tg-uozz">{{pagelink:uscdi_bh_elements, text:USCDI+ BH Elements}}</td>
    ...
    <td class="tg-fapl">{{pagelink:bh_to_fhir_examples, text:USCDI+ BH to FHIR Examples}}</td>
    ...
    <tr>
    <td class="tg-cly1">Technical Artifacts</td>
    <td class="tg-uozz">{{pagelink:bh_to_fhir_profiles, text:USCDI+ BH to Suggestive FHIR Profiles}}</td>
    ...
    <tr>
    <td class="tg-cly1">Technical Artifacts</td>
    <td class="tg-fapl">{{pagelink:artifacts, text:FHIR Artifacts}}</td>
  ...
  <tr>
    ...
    <td class="tg-uozz">{{pagelink:downloads, text:Downloads}}</td>
...
## Dependencies on Other IGs {#dependencies-on-other-igs}
...
## Authors and Project Team {#authors-and-project-team}
